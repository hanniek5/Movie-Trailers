...
avatar = media.Movie("Avatar", "Marine on an alien planet"
                      , """http://t0.gstatic.com/images?q=tbn:
                        ANd9GcQCfmvrE4fMo2cd8esc7mDZPtFSJThAujddMPkRtti1_ij6u-jp"""
...
avengers = media.Movie("Avengers", "Teamwork of Superheroes"
                       , """http://t1.gstatic.com/images?q=tbn:
                           ANd9GcTp0qlAoWcOOswIkL_qpjYzJqCCDmWXiBzCXiqbE43Obo8c0Z-s"""
                       , "https://www.youtube.com/watch?v=eOrNdBpGMv8")

# providing the movie title, storyline, poster image, and trailer URL
happy_feet = media.Movie("Happy Feet", "One Dancing Penguin Spreading Happy Feet"
                         , """https://images-na.ssl-images-amazon.com/images/M/MV5BMTQyNTkxMjUwMV5BMl5BanBnXkFtZTcwMDQ2NTU0MQ@@._
