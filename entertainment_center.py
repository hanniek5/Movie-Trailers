...
wanted = media.Movie("Wanted", "Man who discoveres his skill as an assassin.",
                     ...
                     "172810/p172810_p_v8_an.jpg",
                     "https://www.youtube.com/watch?v=edpEspHOeVU")

# providing the movie title, storyline, poster image, and trailer URL
ninja_assassin = media.Movie("Ninja Assassin",
                             "Ninja Raised to Become an Assassin",
                             "http://t2.gstatic.com/images?q=tbn:ANd9GcSZL"
                             "3_zAx2ygtj-kOs_EfeRK0f5cOaW0PigZklnCwPPXyh5QpWJ",
                             "https://www.youtube.com/watch?v=NhYH26KTNbQ")

# providing the movie title, storyline, poster image, and trailer URL
avengers = media.Movie("Avengers", "Teamwork of Superheroes",
                       "http://t1.gstatic.com/images?q=tbn:ANd9GcTp0qlAoWcO"
                       "OswIkL_qpjYzJqCCDmWXiBzCXiqbE43Obo8c0Z-s",
                       "https://www.youtube.com/watch?v=eOrNdBpGMv8")

# providing the movie title, storyline, poster image, and trailer URL
happy_feet = media.Movie("Happy Feet",
                         "One Dancing Penguin Spreading Happy Feet",
                         "https://images-na.ssl-images-amazon.com/images/M/MV5"
                         "BMTQyNTkxMjUwMV5BMl5BanBnXkFtZTcwMDQ2NTU0MQ@@._V1_UY"
                         "1200_CR90,0,630,1200_AL_.jpg",
...
# open fresh_tomatoes file and open_movies_page function, apply to movies list
